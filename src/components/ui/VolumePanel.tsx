...
import { X, CloudRain, BookOpen, Music, Sun, Cloud, Sunrise, SunMedium, Sunset, Moon, Users, Wine, Utensils } from 'lucide-react';
...
const ALL_TIMES: { value: Time; icon: React.ReactNode; label: string }[] = [
    ...
    { value: '午后', icon: <SunMedium size={18} />, label: '午后' },
...
const ALL_SCENES: { value: Scene; icon: React.ReactNode; label: string }[] = [
    { value: '阅读', icon: <BookOpen size={18} />, label: '阅读' },
    { value: '诗会', icon: <Users size={18} />, label: '诗会' },
    { value: '小酌', icon: <Wine size={18} />, label: '小酌' },
    { value: '美食', icon: <Utensils size={18} />, label: '美食' },
];
